    ...
    return (
        <div className="mt-4 bg-default rounded-md px-4">
            <div className="flex justify-between pt-4">
                <div>
                    <h4 className="text-md font-bold mb-2">Your next patients</h4>
            ...
            <div className="list mt-4" style={{ height: '30vh', overflowX: 'hidden', overflowY: 'auto'}}>
                {
                    patients.map((patient) => {
                        return (
                            <div className="flex gap-12 mb-4" key={patient.id}>
